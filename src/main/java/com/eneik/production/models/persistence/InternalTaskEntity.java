...
public class InternalTaskEntity {
    ...
    public InternalTaskEntity(String id, String title, String status, Integer githubPrNumber, String githubPrState, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        this.id = id;
        this.title = title;
        this.status = status;
